...
messages = {
    "en": [
        "All right reserved",
        "We use cookies to save your language preference. By continuing, you agree to this."
    ],
    "pl": [
        "Wszelkie prawa zastrzeżone",
        "Używamy ciasteczek, aby zapisać twój preferowany język. Kontynuując, akceptujesz to."
    ],
    "es": [
        "Todos los derechos reservados",
        "Usamos cookies para guardar tu preferencia de idioma. Al continuar, aceptas esto."
    ],
    "fr": [
        "Tous droits réservés",
        "Nous utilisons des cookies pour enregistrer votre préférence linguistique. En continuant, vous acceptez cela."
    ],
    "it": [
        "Tutti i diritti riservati",
        "Utilizziamo i cookie per salvare la tua preferenza linguistica. Continuando, accetti questo."
    ]
}
...
const translations = {
    ...
    "es": [
        ...
        "Sudáfrica - Cape Town",
        "Sudáfrica - Durban",
        "Sudáfrica - Johannesburg, Pretoria",
        "Turquía",
        "Serbia",
        "Croacia",
    ...
    "fr": [
        ...
        "Marathon de Karlskrona",
        "Bornholm",
        "Nysa - Odra",
        "Gdańsk - Wilno",
        "Roncevaux - Camino de Santiago",
        "Séville - Camino de Santiago",
    ...
    "it": [
        ...
        "Sudafrica - Cape Town",
        "Sudafrica - Durban",
        "Sudafrica - Johannesburg, Pretoria",
        "Turchia",
        "Serbia",
        "Croazia",
        ...
        "Maratona di Karlskrona",
        "Bornholm",
        "Nysa - Odra",
        "Danzica - Wilno",
        "Roncisvalle - Camino de Santiago",
        "Siviglia - Camino de Santiago",
